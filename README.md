...
# Technicals Achieved
Below is a list of the technicals and other things we incorporated into our website, including our ciphers, quiz game, databse, api/quote encryptor and easter egg, along with the process and methods we used to code, and how it generally is intended to function. 
...
## Quiz Game and Database (Made by Nihar and Rivan)
