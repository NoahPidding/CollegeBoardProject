...
def joke():
    ...
    return render_template("restapi/cryptoapi2.html", menus=menus,  setup=setup, punchline=punchline)
...
def covid19():
    ...
    #return countries
    """
    return render_template("restapi/cryptoapi1.html", menus=menus, world=world,  countries=countries)